...
def load_rgb_frames(image_dir, video_name, indexList):
  frames = []
  for i in indexList:
    img = cv2.imread(os.path.join(image_dir, video_name,'images',str(i).zfill(6)+'.jpg'))
    ...
    for videoName in os.listdir(root):
        ...
        for round in range(1,101):
            ...
            if index <= 75:
                ...
                label = 1
            dataset.append((video_name,indexList,index,label))
    return dataset
